...
import eu.h2020_5gtango.vnv.lcm.restclient.UserSessionManager
...
@Component
class BearerAuthorizationInterceptor implements ClientHttpRequestInterceptor {
    ...
    ClientHttpResponse intercept(HttpRequest request, byte[] body,
        ...
        if(!request.getURI().getPath().endsWith('sessions')){
